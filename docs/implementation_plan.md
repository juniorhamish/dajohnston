...
This document outlines the step-by-step implementation strategy for the Multi-App Portal system. It follows a phased approach to build a solid foundation before adding individual sub-applications.
...
| **1.2** | Configure Backend Baseline (Spring Boot) | Java 25, Gradle, Spring Boot 4.0.3, Spotless + google-java-format. [✓] |
...
2.  **Infrastructure (Phase 2):** Get the local environment running so you can start developing features.
3.  **Identity (Phase 3):** This is the most critical cross-cutting concern. Once this is done, every future app is "secure by default."
